...
if __name__ == "__main__":
    ...
    parser.add_argument("-f", "--file", help="Path to the source file", required=True)
    parser.add_argument("-s", "--source_output", help="Path to the source file", required=True)
    parser.add_argument("-t", "--target_output", help="Path to the source file", required=True)
